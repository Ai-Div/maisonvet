...
export const researchData: ResearchContent = {
  actionItems: [
    ...
    { task: "URGENT — about 2 weeks left: Email cdfa_aus@cdfa.ca.gov — 5-sentence introduction requesting early guidance on nominating Fallbrook/North SD County for a FY2027 veterinary shortage designation, either via email or CDFA's online Qualtrics nomination survey. Confirmed directly from CDFA's own page (August 18, 2026): the Nomination Survey deadline of September 1, 2026 and the separate 'reach out by mid-November for maximum support' line are NOT in conflict — the mid-November guidance applies to the downstream VSGP grant program, not the shortage-designation Nomination Survey itself. September 1, 2026 is the confirmed, hard deadline for the survey, now about 2 weeks away. Unlocks VMLRP (up to $166,800 for Emily) + VSGP-RPE grant ($200,000 equipment) — $366,800 in non-dilutive funding.", completed: false },
