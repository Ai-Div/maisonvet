...
export const researchData: ResearchContent = {
  actionItems: [
    { task: "September 8, 2026 property sweep: two-source confirmed price changes on 40 Oak Glen Rd ($325,000 → $400,000, resolves the August 25 Compass discrepancy) and 14097 Pauma Vista Dr ($377,000 → $395,000, status moved to Pending). 31675 Rancho Amigos Rd's three-way price conflict resolved to $650,000 (Zillow + BHHS agree). 0 Pauma Valley Drive has now failed verification for 5 consecutive weekly runs (LoopNet-only, that fetch also blocked this run) — escalated to hard follow-up: place a direct broker call before the next cycle, remove the card if still unconfirmed after that call.", completed: false },
    { task: "New-listing leads found September 8, 2026 but NOT added to the page — none reached two-source confirmation via Zillow/Redfin/Realtor.com this run (both blocked automated fetches; only single brokerage-mirror sources were available). Verify directly before adding: 26915 Muutama Ln, Valley Center (11.96ac, $285,000, MLS ND25023604, avocado orchard w/ 1.5\" water meter — best value-per-acre of the batch); Huntly Rd, Fallbrook (16.01ac across 2 parcels, $589,000, MLS SW26122000, avocado grove w/ well + 2 domestic meters); 5589 Rainbow Creek Rd, Fallbrook (11.76ac, $475,000, MLS NDP2606912, graded building sites + utilities); 26285 Oak Trail Rd, Valley Center (158.89ac across 2 parcels, $699,000, MLS NDP2600291, massive scale, overlooks Rancho Guejito); 0 El Farra St, Bonsall (38.53ac, $450,000, MLS PTP2601018, no water on-site); 17928 El Brazo, Rancho Santa Fe (2.52ac, ~$1.0-1.2M, MLS 260011099SD, graded pad + ARB-approved 5,500sqft plans, inside gated Cielo HOA — confirm HOA covenants allow a clinic/compound use before pursuing); 0 Lone Hill Lane, Encinitas/Olivenhain (2.46ac, $599,000, MLS NDP2606529).", completed: false },
    { task: "August 25, 2026 property sweep: perform zoning/water verification for the two newly-added candidates — 0 McDonald Rd, Fallbrook (11.35 acres, $898,888, well-vs-meter status unconfirmed) and 30591 Luis Rey Heights Rd, Bonsall (11.98 acres, $575,000, gated community, verify perc test validity). Also confirm 16414 Vesper Rd's corrected 118.56-acre figure and its usable/buildable configuration directly with the listing agent before advancing — the price/acre dropped sharply on this correction.", completed: false },
    ...
    { task: "September 1, 2026 formal CDFA Nomination Survey deadline has passed unsent (confirmed via mailbox check September 8, 2026 — no email ever sent, no reply on file). That specific FY2027 window is closed. However, CDFA separately maintains a year-round 'interested county' list via cdfa_aus@cdfa.ca.gov for counties wanting to be considered in the next cycle's formal survey — the same five-sentence email is still worth sending, just reframed as getting on record for next time rather than meeting this year's deadline. A direct re-check of CDFA's own page (September 15, 2026) confirms the same page separately advises reaching out 'by mid-November for maximum support' — likely the practical target window for the interested-county email, not a new formal deadline. Would still unlock VMLRP (up to $166,800 for Emily) + VSGP-RPE grant ($200,000 equipment) — $366,800 in non-dilutive funding — if a future nomination succeeds. Twelve weeks since first flagged (June 23) and still unsent; the team's call on whether and when to send it now.", completed: false },
    ...
    { task: "A first illustrative Phase 1 Lease P&L sketch is now built (July 28, 2026) from the existing Clinic 10-Year Model's own numbers — see financial notes. It still needs a real lease-rate quote from a North County commercial broker (task above, still not contacted) to replace its $54,000/yr placeholder rent estimate before it can size a real working-capital ask.", completed: false },
    { task: "August 4, 2026 property sweep: confirm two listings that could not be two-source verified — 14097 Pauma Vista Dr (aggregator sources suggest $395,000 vs. the page's $377,000) and 6465 Rainbow Heights Rd Unit 2 (conflicting signals on a possible $495,000 price increase, or a possible delisting). Also confirm whether 0 Cristo Rey (Bonsall, now corrected to 5.26 acres standalone) is part of a larger 50+ acre multi-parcel assemblage referenced in the listing remarks — if so it may still be worth a look at the assemblage price, not the 5.26-acre parcel alone.", completed: false },
    { task: "September 1, 2026 property sweep: URGENT manual follow-up — 0 Pauma Valley Drive has now been absent from Zillow/Redfin/Realtor.com for 4 consecutive weeks (only found on the excluded LoopNet); needs a direct broker call before the next cycle or should be considered for removal. Also still open: 31675 Rancho Amigos Rd (three sources disagree on price — $650K/$550K/$575K), 40 Oak Glen Rd (one source shows $400,000 vs. the page's $325,000), and 14097 Pauma Vista Dr (a low-confidence result suggested Pending/$395,000 — needs a direct check, may just be stale cache of the old pre-correction price). Two held-back candidates from August 25 (0 W Lilac Rd W #20, Bonsall and 26915 Muutama Rd, Valley Center) still couldn't be cleanly resolved this run and remain off the page — worth a direct agent call if either is still wanted.", completed: false },
  ],
  regulatory: [
    {
      title: "CDFA Page Re-Confirmed Unchanged — 'Mid-November' Is Guidance for the Interested-County Email, Not a New Deadline (September 15, 2026)",
      description: "Fetched CDFA's veterinary shortage-area page directly again this week to check for any change since the September 1 formal deadline passed. No change found: the page still states the Nomination Survey 'closed on September 1, 2026,' still separately maintains the year-round 'interested county' list via cdfa_aus@cdfa.ca.gov, and still carries the line 'reach out by mid-November for maximum support, but all interest is welcome.' Reading the two statements together, the mid-November line appears to be practical guidance for whoever sends the still-open interested-county email — not a second formal deadline — since CDFA also separately states 'Fall 2026 — USDA FY 2027 Shortage Situation Nominations are expected to open for county designations,' meaning outreach before mid-November would land ahead of that expected window. No email has yet been sent; still the team's call on whether and when.",
    },
    {
      title: "CDFA Nomination Survey Deadline Has Passed Unsent — But a Standing 'Interested County' Channel Remains Open (September 8, 2026)",
      description: "The September 1, 2026 Nomination Survey deadline has now passed. A direct mailbox check (sent items and inbox, no date restriction) found no email ever sent to cdfa_aus@cdfa.ca.gov and no reply from CDFA — the formal FY2027 nomination window for Fallbrook/North San Diego County was missed. This closes this specific step for this cycle. New this week: independent research into CDFA's own program description found the agency separately maintains a year-round 'interested county' list, and explicitly invites parties to email cdfa_aus@cdfa.ca.gov at any time to flag a county/region for future consideration, ahead of when the next formal Nomination Survey opens (expected Fall of the following year for the next cycle). This does not undo the missed FY2027 window, but it means the same five-sentence, zero-cost email is still worth sending — just reframed from 'meet this year's deadline' to 'get Fallbrook/North San Diego County on record now for the next cycle.' Whether and when to send it is the team's call.",
    },
    {
      title: "CDFA Deadline Now One Week Away — Introduction Email Still Unsent (August 25, 2026)",
      description: "Independent public-source search this week (separate from last week's direct CDFA page re-check) turned up no change to the picture: the Fall 2026 nomination window, the cdfa_aus@cdfa.ca.gov contact channel, and the 8-nominations-per-cycle federal forwarding cap are all consistent with what's already logged. What has changed is simply the calendar — the September 1, 2026 Nomination Survey deadline confirmed August 18 is now about one week away, and the five-sentence, zero-cost introduction email has been an open item since June 23 (nine weeks). This is now the single most time-sensitive open item on the board; flagging with the highest urgency this cycle.",
    },
    {
      title: "CDFA Confirms September 1 Deadline Is Real and Separate From the Mid-November Guidance (August 18, 2026)",
      description: "Went back to CDFA's veterinary shortage-area page directly to resolve the conflict flagged August 11 between a 'Nomination Survey closes September 1, 2026' statement and a 'reach out by mid-November for maximum support' statement on the same page. Confirmed: the two are not in conflict, they cover different things. The Nomination Survey (submitted online via CDFA's Qualtrics form or emailed to cdfa_aus@cdfa.ca.gov) is what actually nominates a region like Fallbrook/North San Diego County for a shortage designation, and its deadline is September 1, 2026 — a hard date, now about two weeks out. The mid-November line is separate guidance about the downstream VSGP grant program, not the nomination step. This removes the ambiguity: the still-unsent introduction email to cdfa_aus@cdfa.ca.gov (a five-sentence, zero-cost action) needs to go before September 1, 2026, or the region misses this year's nomination cycle — and per the August 4 finding, a missed cycle can mean a multi-year wait for the next one, not a short delay.",
    },
    {
    ...
    {
      title: "CDFA Nomination Survey Deadline Found: September 1, 2026 — Tighter Than Previously Tracked (August 11, 2026)",
      description: "Checked CDFA's own veterinary shortage-area page (cdfa.ca.gov/ahfss/AUS/CAVetNeeds.html) directly for a firmer date, since prior notes only had 'Fall 2026, contact before mid-November' as guidance. The page now states in two independent passes that 'the next CDFA Nomination Survey will close on September 1, 2026' for the FY2027 cycle — about three weeks from today. Confusingly, the same page separately says to 'reach out by mid-November for maximum support,' which may describe informal early-interest outreach rather than the formal survey deadline; the two statements were not reconciled on the page itself and this needs a direct confirmation call or email to CDFA before treating either one as certain. Given the downside of missing a cycle (confirmed August 4: a skipped year can mean a multi-year wait, since CA forwards only 8 nominations per cycle), the safer planning assumption is to treat September 1, 2026 as the real deadline rather than mid-November. Separately, confirmed the downstream federal timeline from the same page: VMLRP applications are expected to open January 2027, with a Letter of Intent due late 2026/January 2027, and VMLRP/VSGP applications due March-April 2027 — consistent with, and a bit more specific than, what was previously logged. The introduction email to cdfa_aus@cdfa.ca.gov remains unsent; this is a zero-cost, five-sentence action still awaiting the team."
    },
    {
      title: "CDFA Veterinary Shortage Nomination Mechanics — Why Early Contact Matters (August 4, 2026)",
      description: "Confirmed how the nomination pipeline actually works: California's State Veterinarian reviews county/regional nominations and forwards only up to 8 to the federal VMLRP program per cycle — a competitive filter before USDA even sees a nomination. Separately, USDA NIFA halted the VMLRP program entirely for FY2025 (no new nominations accepted that year), and the FY2026 VMLRP/VSGP funding cycle that just opened had to fall back on nominations submitted back in FY2024. This is why the still-unsent introduction to cdfa_aus@cdfa.ca.gov (recommended before mid-November, ahead of the Fall 2026 window) matters: missing a cycle isn't a short delay, it can mean waiting years for the next one. Still a zero-cost, five-sentence email; still not sent."
    },
  ],
  financial: [
    {
      title: "Property Inventory Check — Full Re-verification, No Net Changes, Pauma Valley Drive Now 4 Weeks Unconfirmed (September 1, 2026)",
      description: "Re-verified all 26 tracked listings this run (one attempt per source per the failure-handling budget). Net change: 26 → 26 active properties — zero added, zero removed, zero price/acreage changes published. Every conflict flagged on August 25 remained unresolved after this run's single verification pass and was left unchanged per the two-source rule: 40 Oak Glen Rd (one source still shows $400,000 vs. the page's $325,000), 31675 Rancho Amigos Rd (three sources still disagree — $650,000/$550,000/$575,000 — page held at $650,000), and 14097 Pauma Vista Dr (a low-confidence aggregated result suggested a 'Pending' status at $395,000, but $395,000 matches this property's old pre-correction price and could not be corroborated by a direct source this run — treated as likely stale cache, not acted on). 0 Pauma Valley Drive is now on its 4th consecutive week absent from Zillow, Redfin, and Realtor.com, found only on the excluded LoopNet — left on the page (no direct evidence of sold/off-market status) but this is now the single highest-priority manual follow-up; recommend a direct broker call before the next cycle. Re-examined the two candidates the August 25 run held back (0 W Lilac Rd W #20, Bonsall, ~$1,425,000/20.2 ac and 26915 Muutama Rd, Valley Center, ~12 ac) — neither cleared the bar this run either: Lilac Rd's active-vs-delisted status is still unresolved (direct listing-page fetches returned 403/404), and Muutama Rd's price is still ambiguous (search results split between $285,000 and $308,000, and the MLS# ND25023604 listing page now redirects to a generic search page, a possible delisting signal) — both remain held back, not added. Also caught and discarded a false positive before it could reach the page: an aggregated search result briefly suggested Parcel 3 & 4 Emerald Hill Rd was listed at $4,100,000; a direct fetch of the actual listing page plus a second independent source both confirmed the real, unchanged price of $1,074,000 — page not touched. Searched Tiers 1-3 (Rancho Santa Fe/Fairbanks Ranch, Encinitas/Olivenhain, Carlsbad) again for new qualifying listings under the $2.2M cap — a Carlsbad 92009 8.26-acre/$1,395,000 parcel (7573 Delgado) was found but is listed Pending, not Active, so it was excluded rather than added.",
    },
    {
      title: "Property Inventory Check — Vesper Rd Acreage Corrected, Two New Fallbrook/Bonsall Candidates (August 25, 2026)",
      description: "Weekly property check across all 24 tracked listings (up from 23 in the prior log entry — the page has grown steadily as new candidates clear the two-source bar). Corrected a data error on 16414 Vesper Rd (Valley Center): two independent sources (Zillow and Coldwell Banker, both citing MLS# IV26080668) now agree the parcel is 118.56 acres, not the 15.89 acres previously published — price unchanged at $1,495,000, but effective price/acre drops from ~$94,000 to ~$12,600. Added two new two-source-verified candidates: 0 McDonald Rd, Fallbrook ($898,888, 11.35 acres across 2 parcels, confirmed price cut from $999,000 via Coldwell Banker Homes and Sereno) and 30591 Luis Rey Heights Rd, Bonsall ($575,000, 11.98 acres, income-producing avocado/protea/eucalyptus grove in the gated San Luis Rey Groves community, water meter included). Three additional candidates were found but held back pending stronger verification: 0 Tierra Nuevo Rd, Fallbrook (~$375,000/26 ac, only one independent source confirmed, plus an unresolved conflicting $2,595,000 'coming soon' signal tied to an older MLS#); 0 W Lilac Rd W #20, Bonsall (~$1,425,000/20.2 ac, price/acreage corroborated but active-vs-delisted status unresolved — one source claims it's no longer active); and 26915 Muutama Rd, Valley Center (~11.96 ac, price unresolved between $285,000 and $295,000, no successful direct source fetch). Searched Tiers 1-3 (Rancho Santa Fe/Fairbanks Ranch, Encinitas/Olivenhain, Carlsbad) exhaustively for new qualifying listings under the $2.2M cap — confirmed nothing currently clears both acreage and price in these zones; Rancho Santa Fe/Fairbanks Ranch land runs roughly $1.5-2.2M per acre, so the $2.2M budget buys 1-1.5 acres there, not 10+. Flagged as unverifiable or conflicting this run, left unchanged on the page: 14097 Pauma Vista Dr (third consecutive week with no clean primary-source match — highest-priority manual follow-up), 0 Pauma Valley Drive (third consecutive week absent from Zillow/Redfin/Realtor.com, only found on the excluded LoopNet — consider removal next cycle if still unconfirmed), 31675 Rancho Amigos Rd (three sources now show three different prices — $650,000/$550,000/$575,000 — page held at $650,000 pending a direct agent call), and 40 Oak Glen Rd (one secondary source shows a $400,000 asking price vs. the page's $325,000, not yet two-source confirmed). Net change: 24 → 26 active properties (two added, zero removed, one acreage correction).",
    },
    {
      title: "Property Inventory Check — Sold Removal, Two Bonsall Additions, Vesper Rd Acreage Flag (August 11, 2026)",
      description: "Weekly property check across all 23 tracked listings. 9932 Gomez Creek Rd (Fallbrook) confirmed sold via two independent sources (closed 11/17/25) — removed from the active page; sources disagreed on the exact closing price ($185,000 vs. $205,000) so no sold price was published. 0 Pauma Heights Rd Lot 9 (Valley Center) moved to Pending per two independent sources — left on the page with a Pending note rather than removed, since it isn't confirmed sold/off-market. Added two new two-source-verified Bonsall (Tier 5) candidates: 31675 Rancho Amigos Rd ($650,000, 19.28 acres, active Haas avocado grove, 2\" ag water meter) and Highway 395/Mountain View Rd ($1,100,000, 32.01 acres, A-70 zoning, water source unconfirmed). Searched Tiers 1-3 (Rancho Santa Fe, Encinitas/Olivenhain, Carlsbad) for new qualifying listings — nothing cleared both the price ceiling and zoning/acreage fit this round. Flagged for manual follow-up rather than guessed: 16414 Vesper Rd's acreage shows 118.56 acres on Zillow and Redfin this run vs. the 15.89 acres published (price unchanged at $1,495,000) — held at the current figure pending direct confirmation given the size of the jump. Also flagged as unverifiable or conflicting this run, left unchanged: Aspen Rd (possible unconfirmed contract), 6465 Rainbow Heights Rd Unit 2 (possible inactive signal on one broker mirror), 0 Via Panorama (single unconfirmed $550,000 relist mention), 0 Mt Olympus Valley Rd (conflicting single-source acreage), 0 Pauma Valley Drive (no source hits this run), and Parcel 3 & 4 Emerald Hill Rd (not indexed on Zillow/Redfin/Realtor.com, only on Coldwell Banker). Net change: 23 → 24 active properties (one removed, two added, one sold)."
    },
    {
      title: "Property Inventory Check & Cristo Rey Acreage Correction (August 4, 2026)",
      description: "Weekly property check across all 23 tracked listings. Corrected a data error on 0 Cristo Rey (Bonsall): the page had shown 36.78 acres, but three independent sources (Redfin, RSR Real Estate, LandWatch) confirm the $150,000 listing under MLS# SW25117707 is 5.26 acres standalone — the 36.78 figure appears to have conflated it with a separate 50+ acre multi-parcel assemblage referenced in the listing remarks. At 5.26 acres it no longer clears the 10+ acre compound threshold on its own (Bonsall is Tier 5, not eligible for the reduced-acreage exception); downgraded from Strong Candidate to Investigate pending confirmation of assemblage terms. Also resolved an ambiguous price range on 0 Mt Olympus Valley Rd (Fallbrook) to a confirmed $349,900 — the $375,000 figure belongs to a different, larger 46.64-acre parcel on the same road. Two listings could not be confidently verified this run and need manual/live follow-up: 14097 Pauma Vista Dr (two aggregator sources, same underlying MLS feed, suggest $395,000 vs. the page's $377,000) and 6465 Rainbow Heights Rd Unit 2 (conflicting signals — a possible price increase to $495,000, consistent with a prior June 4, 2026 log entry noting the same figure, and one source suggesting the listing may have been pulled). No changes made to either pending confirmation. Searched Tiers 1-3 (Rancho Santa Fe, Encinitas/Olivenhain, Carlsbad) for new qualifying listings under the $2.2M cap — nothing new cleared both the price ceiling and zoning/use fit this round; several promising-looking leads (Olivenhain 9.9-acre lot, Carlsbad large-acreage parcels) turned out to be over budget or mobile-home-park land, not usable rural-residential/ag parcels."
    },
    {
      title: "Illustrative Phase 1 Lease P&L Sketch — First Cut (July 28, 2026)",
      description: "Built a first illustrative Year 1 Lease P&L by taking the Clinic 10-Year Model's own Year 1 line items (same placeholder patient-volume assumption, Rachael corrected to $100,000) and swapping the owned-campus fixed costs for leased-space equivalents: the $30,000 Property Tax line and $22,000 owned-building Facilities Reserve are replaced with a ~$10,000 tenant-side maintenance reserve plus a placeholder $54,000/yr (~$4,500/mo) Fallbrook commercial rent estimate for a built-out ~2,500 sq ft space. Net effect: illustrative Lease Total Operating Expenses of about $231,964 — roughly $12,000 MORE than the owned-campus model's $219,964, because placeholder rent costs more than the property-tax line it replaces. Illustrative Lease EBITDA (Year 1) is about -$95,000, versus the owned-campus model's corrected -$83,231. The real financial case for leasing isn't a cheaper Year 1 operating line — it's avoiding the ~$262,000/yr campus debt service and ~$165,000/yr campus depreciation load; swapped in, a modest equipment-lease payment (~$18,000/yr, per the ~$1,500/mo Phase 1 startup-budget figure) and small TI/equipment depreciation apply instead. This is a sketch built from existing model numbers, not a real quote — it still needs an actual lease-rate quote from a North County commercial broker (not yet contacted) to replace the $54,000/yr placeholder before it can size a real working-capital ask. It does, however, roughly confirm the prior ~$300K Phase 1 working-capital order-of-magnitude estimate as still in the right range."
    },
    {
