...
export const researchData: ResearchContent = {
  actionItems: [
    ...
    { task: "URGENT — deadline now looks much closer than previously tracked: Email cdfa_aus@cdfa.ca.gov — 5-sentence introduction requesting early guidance on nominating Fallbrook/North SD County for a FY2027 veterinary shortage designation. CDFA's own page now states the official CDFA Nomination Survey for this cycle closes September 1, 2026 (about 3 weeks from August 11) — a much tighter deadline than the 'contact before mid-November' guidance logged previously, which appears elsewhere on the same page and may refer to informal early outreach rather than the formal survey. This conflict needs direct confirmation with CDFA, but for planning purposes September 1 should now be treated as the operative date. Unlocks VMLRP (up to $166,800 for Emily) + VSGP-RPE grant ($200,000 equipment) — $366,800 in non-dilutive funding.", completed: false },
