...
export const researchData: ResearchContent = {
  actionItems: [
    ...
    { task: "URGENT — about 1 week left (deadline September 1, 2026): Email cdfa_aus@cdfa.ca.gov — 5-sentence introduction requesting early guidance on nominating Fallbrook/North SD County for a FY2027 veterinary shortage designation, either via email or CDFA's online Qualtrics nomination survey. Confirmed directly from CDFA's own page (August 18, 2026) and reconfirmed via independent public search (August 25, 2026, no change found): the Nomination Survey deadline of September 1, 2026 and the separate 'reach out by mid-November for maximum support' line are NOT in conflict — the mid-November guidance applies to the downstream VSGP grant program, not the shortage-designation Nomination Survey itself. September 1, 2026 is the confirmed, hard deadline for the survey. Unlocks VMLRP (up to $166,800 for Emily) + VSGP-RPE grant ($200,000 equipment) — $366,800 in non-dilutive funding. Nine weeks since this was first flagged (June 23) and still unsent.", completed: false },
