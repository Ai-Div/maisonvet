        ...
        <ul className="flex items-center gap-6 h-10 whitespace-nowrap">
          {sections.map((s) => (
            <li key={s.href}>
              <a
                href={s.href}
                className="text-xs font-bold uppercase text-stone-500 hover:text-stone-900 focus-visible:ring-2 focus-visible:ring-stone-900 rounded-sm transition-colors duration-200"
                itemProp="url"
              >
                {s.label}
              </a>
